...
pyautogui.write("IT00")
pyautogui.press('tab')
pyautogui.write("%^56TYty")
...
source_path = "C:/Users/khkimb/Documents/SAP/SAP GUI/"
file_name = "export.MHTML"
target_file = "SE16N_CD_KEY.MHTML"
file_copy(source_path, target_path, file_name, target_file)   # 파일카피 - SE16N_CD_KEY 파일
...
file_copy(source_path, target_path, file_name, target_file)   # 파일카피 - ZAUR0400 파일
